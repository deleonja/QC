...
definan canales. Si no, creo que puede causar confusion. } 1-qubit density
...
specifies the total number of quantum channels for a n-qubit  \cpnote{Cambia a $n$-qubit, nota que 
acá la n es en formato de formula} system.}
\label{fig:CCs-by-components}
\end{figure} % }}}

\item Empirical observations of 2-qubit results led us to some rules that
patterns in Figures  \cpnote{quizá acá diagrams en vez de figures?} obey:
\begin{enumerate}
...
be erased. \cpnote{Tambien una figurita aca o una referencia a algun diagrama estaría padre. 
...
channel. \cpnote{Esto también hay que explicar que efecto tiene en los diagramas}
\end{itemize}

\cpnote{Esto amerita otra sección aparte}
