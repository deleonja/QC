...
\begin{enumerate}
	...
	\item Permutations of columns and/or rows: These operations generally are not CPTP maps, for instance the swap of rows (or columns) result in reflections of the Bloch sphere of individual particles. Aside from that, it is clear that they connect \pce{} maps.
