...
\begin{frame}[plain]
  ...
  \begin{tikzpicture}[x=1mm,y=1mm,overlay,remember picture]
    ...
    {\includegraphics[height=12mm]{images/ecfmByN}};
    \node[inner sep=0pt] (usac) at (0,-30) %
    {\includegraphics[height=12mm]{images/ifunam}};
    \node[inner sep=0pt] (ecfm) at (35,-30) %
    {\includegraphics[height=12mm]{images/u-pernambuco}};
  \end{tikzpicture}
\end{frame}
...
\begin{frame}{Sistemas cuánticos abiertos}{¿Qué son?}
	...
	\vspace{-.1cm}
	\begin{center}
		\includegraphics[height=5.5cm]{images/cerrados.pdf}
	\end{center}
  }
	...
	\vspace{-.1cm}
	\begin{center}
		\includegraphics[height=5.5cm]{images/abiertos.pdf}
	\end{center}
  }  
