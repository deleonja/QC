...
def combinations_of_correlations(n, num_of_corr):
...
def maps_in_Pauli_basis(n, param, num_of_corr):
	'''
	Constructs, in the Pauli basis, all the posible maps that leave invariant a certain qbit-system's number of correlations.
	...
	r = combinations_of_correlations(n, num_of_corr) 
